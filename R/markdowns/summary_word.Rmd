...
-   Scenarios are applied over the period 2025-2030

Stock objects setting used in forecast period are:

-   Biological quantities (rec, weigth, mat) used for forecast are the mean of most five recent years (2020-2022). Five year is preferred because 2022 was already set as the mean of 2019-2021 given the methodology applied by [@stecf2023a].
